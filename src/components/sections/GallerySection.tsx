...
const images: GalleryImage[] = [
  ...
  { id: 2, src: photo3, alt: "Приэльбрусье", category: "Природа" },
  { id: 3, src: photo4, alt: "Бурная река в Адыгее", category: "Природа" },
  { id: 4, src: photo5, alt: "Бурная река в Архызе", category: "Природа" },
  // Город (photos 6-9)
  { id: 5, src: photo6, alt: "Кутаиси", category: "Город" },
  { id: 6, src: photo7, alt: "Стамбул", category: "Город" },
  { id: 7, src: photo8, alt: "Магазин ковров, Тбилиси", category: "Город" },
  { id: 8, src: photo9, alt: "Тбилиси", category: "Город" },
  ...
  { id: 12, src: photo13, alt: "Елизавета в горах, Приэльбрусье", category: "Путешествия" },
];
